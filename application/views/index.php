		...
		<div class="flex flex-row justify-center">
			<div class="flex flex-row rounded-xl shadow-lg">
				...
				<div class="border-t-2 border-b-2 p-10">
					<div class="poppins w-full text-center text-base font-medium">Pilih File Peserta Diklat</div>
		...
		<div class="mt-10 w-full mx-auto text-center">
			<button class="gap-2 px-5 py-3 rounded-lg font-bold bg-blue-500 text-white hover:bg-blue-700 hover:shadow-xl">
				<div class="flex flex-row gap-2">
					...
					<svg id="button-spinner" aria-hidden="true" class="w-4 h-4 text-gray-200 animate-spin fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
